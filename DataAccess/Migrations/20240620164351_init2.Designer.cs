...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240620164351_init2")]
    partial class init2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.MovimientoDeStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CantidadDeUnidadesMovidas")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.TipoDeMovimiento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.MovimientoDeStock", b =>
                {
                    ...
                    b.HasOne("Domain.Models.TipoDeMovimiento", "TipoDeMovimiento")
                        .WithMany()
                        .HasForeignKey("TipoDeMovimientoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Models.Usuario", "Empleado")
                        .WithMany()
